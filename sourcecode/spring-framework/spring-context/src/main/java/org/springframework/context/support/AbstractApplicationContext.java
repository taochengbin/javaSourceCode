...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		// 这里的getBeanFactoryPostProcessors()是获取自定义的BeanFactoryPostProcesser
		// （就是程序员自己写的，并且没有交给spring管理，就是没有加上@Component）
		// context.addBeanFactoryPostProcessor(new MyBeanFactoryProcessor());手动set  getBeanFactoryPostProcessors才会有值
